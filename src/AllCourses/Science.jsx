  ...
  useEffect(() => {
    const getLesson = async () => {
      try {
        ...
        const proglesson = res.data.filter(lesson => lesson.category === "science");
  ...
  return (
    <>
      <div className='pt-10 px-4 md:px-10 lg:px-20 text-black bg-white dark:text-white dark:bg-slate-900'>
        <h1 className='text-left text-xl pt-20 md:text-3xl lg:text-4xl'>Learn Science</h1>
